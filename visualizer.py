        ...
        if hasattr(self.master.tracker, "xy"):
            for i in range(self.master.tracker.xy.shape[0]):
                if self.master.tracker.r[i] < self.master.threshold:
                    cv2.circle(img, (int(self.master.tracker.xy[i, 0]), int(self.master.tracker.xy[i, 1])), int(self.master.tracker.r[i]), (0, 204, 0), 3)
                    cv2.circle(img, (int(self.master.tracker.xy[i, 0]), int(self.master.tracker.xy[i, 1])), 3, (0, 204, 0), -1)
                else:
